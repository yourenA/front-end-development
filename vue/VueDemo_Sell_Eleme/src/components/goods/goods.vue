<template lang="html">
  ...
  <div class="goods">
    <div class="menu-wrapper" ref="menuWrapper">
      <ul>
        <!--$event vue中的事件对象-->
        <!--v-for中的点击事件第一个参数为index,第二个参数为$event对象-->
...
//          console.log("food",food)
  ...
  methods: {
     ...
     * */
    _calculateHeight() {
      let foodList = this.$refs.foodsWrapper.querySelectorAll('.food-list-hook')//获取右边foods列表，this.$nextTick后已经渲染完成
      let height = 0  //初始高度为0
    ...
    goDetail(food) {
      this.selectedFood = food//响应式数据改变以后，子组件就有内容
      /**
